...
export const ProductForm = ({ product, categories }: Props) => {
	...
	const onSubmit = async (data: FormInputs) => {
		...
		if (!ok) {
			//Todo: agregar un gestor visual para avisarle al usuario.
					...
					<div className="flex flex-wrap">
						{sizes.map((size) => (
							<div
								...
								className={clsx(
									"p-2 border cursor-pointer text-center rounded-md m-2 mb-2 w-14 transition-all hover:bg-blue-500 hover:text-white",
									{
