"use client";
import { generatePaginationNmubers } from "@/utils/generatePaginationNumbers";
...
export const Pagination = ({ totalPages }: Props) => {
	...
	const allPages = generatePaginationNmubers(currentPage, totalPages);
						...
						<li key={page} className="page-item">
							<Link
								className={clsx(
									...
									{
										"bg-blue-500 hover:bg-blue-700 hover:text-white shadow-md text-white":
											page === currentPage,
									}
								)}
